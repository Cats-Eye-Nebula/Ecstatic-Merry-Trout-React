...
const B0510 = (props) => {
  return (
    <div className="b0510-container">
      <Helmet>
        <title>B0510 - Ecstatic Merry Trout</title>
        <meta property="og:title" content="B0510 - Ecstatic Merry Trout" />
      </Helmet>
      <div className="b0510-marketing">
        <div className="b0510-side-menu Sidemenu-Layout">
          <div className="b0510-logo">
            <img
              alt="image"
              src="https://play.teleporthq.io/static/svg/default-img.svg"
              className="b0510-image"
            />
          </div>
          <Link to="/">
            <div className="b0510-overview sidemenu-reg">
          ...
          <Link to="/b02">
            <div className="b0510-my-workspace sidemenu-reg">
              <svg viewBox="0 0 1024 1024" className="sidemenu-icon-reg">
          ...
          <Link to="/b03">
            <div className="b0510-calendar sidemenu-reg">
              <svg
              ...
              <span className="b0510-calendar-text sidemenu-typo-reg">
                Calendar
              </span>
            </div>
          </Link>
          <Link to="/b04">
            <div className="b0510-assets-cont sidemenu-reg">
              <svg viewBox="0 0 1024 1024" className="sidemenu-icon-reg">
              ...
              <span className="b0510-assets-text LightBasicTypographyParagraph sidemenu-typo-reg">
                Assets
              </span>
            </div>
          </Link>
          <div className="b0510-marketing-overview sidemenu-reg">
            <div className="b0510-marketing1 sidemenu-reg">
              <svg viewBox="0 0 1024 1024" className="sidemenu-icon-reg">
              ...
              <span className="b0510-marketing-text sidemenu-typo-reg">
                Marketing
              </span>
              <svg
                viewBox="0 0 1024 1024"
                className="b0510-icon05 sidemenu-icon-reg"
              >
            ...
            <Link to="/b0501" className="b0510-navlink04">
              <div className="b0510-marketing-a light-ssm-reg">
                <svg
                ...
                <span className="b0510-marketing-website sidemenu-typo-reg">
                  <span>Overview</span>
                  <br></br>
                </span>
              </div>
            </Link>
            <Link to="/b0502" className="b0510-navlink05">
              <div className="b0510-marketing-b light-ssm-reg">
                <svg
                  viewBox="0 0 877.7142857142857 1024"
                  className="light-ssm-icon-reg"
                >
                ...
                <span className="b0510-marketing-ct sidemenu-typo-reg">
                  Calendar &amp; Task
                </span>
              </div>
            </Link>
            <Link to="/b0503" className="b0510-navlink06">
              <div className="b0510-marketing-c light-ssm-reg">
                <svg
                  viewBox="0 0 877.7142857142857 1024"
                  className="b0510-marketing-icon-c light-ssm-icon-reg"
                >
                  <path d="M438.857 201.143c-171.429 0-310.857 139.429-310.857 310.857s139.429 310.857 310.857 310.857 310.857-139.429 310.857-310.857-139.429-310.857-310.857-310.857zM877.714 512c0 242.286-196.571 438.857-438.857 438.857s-438.857-196.571-438.857-438.857 196.571-438.857 438.857-438.857v0c242.286 0 438.857 196.571 438.857 438.857z"></path>
                </svg>
                <span className="b0510-marketing-website1 sidemenu-typo-reg">
                  Website
                </span>
              </div>
            </Link>
            <Link to="/b0504" className="b0510-navlink07">
              <div className="b0510-marketing-d light-ssm-reg">
                <svg
                  viewBox="0 0 877.7142857142857 1024"
                  className="light-ssm-icon-reg"
                >
                ...
                <span className="b0510-marketing-website2 sidemenu-typo-reg">
                  SEO
                </span>
              </div>
            </Link>
            <Link to="/b0505" className="b0510-navlink08">
              <div className="b0510-marketing-e light-ssm-reg">
                <svg
                  viewBox="0 0 877.7142857142857 1024"
                  className="light-ssm-icon-reg"
                >
                ...
                <span className="b0510-marketing-website3 sidemenu-typo-reg">
                  Socials
                </span>
              </div>
            </Link>
            <Link to="/b0506" className="b0510-navlink09">
              <div className="b0510-marketing-f light-ssm-reg">
                <svg
                  viewBox="0 0 877.7142857142857 1024"
                  className="light-ssm-icon-reg"
                >
                ...
                <span className="b0510-marketing-website4 sidemenu-typo-reg">
                  Email Campaign
                </span>
              </div>
            </Link>
            <Link to="/b0507" className="b0510-navlink10">
              <div className="b0510-marketing-g light-ssm-reg">
                <svg
                  viewBox="0 0 877.7142857142857 1024"
                  className="light-ssm-icon-reg"
                >
                ...
                <span className="b0510-marketing-website5 sidemenu-typo-reg">
                  Referral
                </span>
              </div>
            </Link>
            <Link to="/b0508" className="b0510-navlink11">
              <div className="b0510-marketing-h light-ssm-reg">
                <svg
                  viewBox="0 0 877.7142857142857 1024"
                  className="light-ssm-icon-reg"
                >
                ...
                <span className="b0510-marketing-website6 sidemenu-typo-reg">
                  <span>Affiliates</span>
                  <br></br>
                </span>
              </div>
            </Link>
            <Link to="/b0509" className="b0510-navlink12">
              <div className="b0510-marketing-i light-ssm-reg">
                <svg
                  viewBox="0 0 877.7142857142857 1024"
                  className="light-ssm-icon-reg"
                >
                ...
                <span className="b0510-marketing-website7 sidemenu-typo-reg">
                  <span>Promotion</span>
                  <br></br>
                </span>
              </div>
            </Link>
            <div className="b0510-marketing-j light-ssm-active light-ssm-reg">
              <svg
                viewBox="0 0 877.7142857142857 1024"
                className="b0510-marketing-icon-b1 light-ssm-icon-reg"
              >
                <path d="M438.857 201.143c-171.429 0-310.857 139.429-310.857 310.857s139.429 310.857 310.857 310.857 310.857-139.429 310.857-310.857-139.429-310.857-310.857-310.857zM877.714 512c0 242.286-196.571 438.857-438.857 438.857s-438.857-196.571-438.857-438.857 196.571-438.857 438.857-438.857v0c242.286 0 438.857 196.571 438.857 438.857z"></path>
              </svg>
              <span className="b0510-marketing-ct1 sm-typo-active">Others</span>
            </div>
            <Link to="/b0511" className="b0510-navlink13">
              <div className="b0510-marketing-k light-ssm-reg">
                <svg
                  viewBox="0 0 877.7142857142857 1024"
                  className="light-ssm-icon-reg"
                >
                ...
                <span className="b0510-marketing-website8 sidemenu-typo-reg">
                  <span>Settings</span>
                  <br></br>
                </span>
              </div>
          ...
          <Link to="/b0601">
            <div className="b0510-advertising sidemenu-reg">
              <svg viewBox="0 0 1024 1024" className="sidemenu-icon-reg">
              ...
              <span className="b0510-advertising-text sidemenu-typo-reg">
                Advertising
              </span>
              <svg viewBox="0 0 1024 1024" className="sidemenu-icon-reg">
          ...
          <Link to="/b07">
            <div className="b0510-sales sidemenu-reg">
              <svg
              ...
              <span className="b0510-sales-text sidemenu-typo-reg">Sales</span>
            </div>
          </Link>
          <Link to="/b08">
            <div className="b0510-project sidemenu-reg">
              <svg viewBox="0 0 1024 1024" className="sidemenu-icon-reg">
              ...
              <span className="b0510-project-text sidemenu-typo-reg">
                Project
              </span>
            </div>
          </Link>
          <Link to="/b09">
            <div className="b0510-customer-service sidemenu-reg">
              <svg viewBox="0 0 1024 1024" className="sidemenu-icon-reg">
              ...
              <span className="b0510-cs-text sidemenu-typo-reg">
                Customer Service
              </span>
            </div>
          </Link>
          <Link to="/b1001">
            <div className="b0510-human-resource sidemenu-reg">
              <svg
              ...
              <span className="b0510-hr-text sidemenu-typo-reg">HR Mgmt</span>
              <svg viewBox="0 0 1024 1024" className="sidemenu-icon-reg">
                <path d="M426 256l256 256-256 256-60-60 196-196-196-196z"></path>
              </svg>
            </div>
          ...
          <Link to="/b12">
            <div className="b0510-learn-help sidemenu-reg">
              <svg
              ...
              <span className="b0510-lh-text sidemenu-typo-reg">
                Learn &amp; Help
              </span>
            </div>
          </Link>
          <Link to="/b11">
            <div className="b0510-reports sidemenu-reg">
              <svg viewBox="0 0 1024 1024" className="sidemenu-icon-reg">
              ...
              <span className="b0510-reports-text sidemenu-typo-reg">
                Reports
              </span>
            </div>
          </Link>
          <Link to="/b13">
            <div className="b0510-settings sidemenu-reg">
              <svg
              ...
              <span className="b0510-settings-text sidemenu-typo-reg">
                Settings
              </span>
            </div>
          </Link>

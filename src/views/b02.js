...
const B02 = (props) => {
  return (
    <div className="b02-container">
      <Helmet>
        <title>B02 - Ecstatic Merry Trout</title>
        <meta property="og:title" content="B02 - Ecstatic Merry Trout" />
      </Helmet>
      <div className="MainLayout">
        <div className="Sidemenu-Layout mode-sidemenu-light">
          <div className="Sidemenu-logo">
            <img
              alt="image"
              src="https://play.teleporthq.io/static/svg/default-img.svg"
              className="sidemenu-logo-size"
            />
          </div>
          <Link to="/">
            <div className="b02-overview020102 sidemenu-reg">
              <svg
          ...
          <Link to="/b03">
            <div className="b02-calendar sidemenu-reg">
              <svg
              ...
              <span className="b02-calendar-text mode-sm-typo-light sidemenu-typo-reg">
                Calendar
              </span>
            </div>
          </Link>
          <Link to="/b03">
            <div className="b02-assets sidemenu-reg">
              <svg
                viewBox="0 0 1024 1024"
                className="sidemenu-icon-reg mode-icon-sm-light"
              >
              ...
              <span className="b02-assets-text LightBasicTypographyParagraph mode-sm-typo-light sidemenu-typo-reg">
                Assets
              </span>
            </div>
          </Link>
          <Link to="/b0501">
            <div className="b02-marketing sidemenu-reg">
              <svg
                viewBox="0 0 1024 1024"
                className="sidemenu-icon-reg mode-icon-sm-light"
              >
              ...
              <span className="b02-marketing-text mode-sm-typo-light sidemenu-typo-reg">
                Marketing
              </span>
              <svg
                viewBox="0 0 1024 1024"
          ...
          <Link to="/b0601">
            <div className="b02-advertising sidemenu-reg">
              <svg
                viewBox="0 0 1024 1024"
                className="sidemenu-icon-reg mode-icon-sm-light"
              >
              ...
              <span className="b02-advertising-text mode-sm-typo-light sidemenu-typo-reg">
                Advertising
              </span>
              <svg
                viewBox="0 0 1024 1024"
          ...
          <Link to="/b07">
            <div className="b02-sales sidemenu-reg">
              <svg
              ...
              <span className="b02-sales-text mode-sm-typo-light sidemenu-typo-reg">
                Sales
              </span>
            </div>
          </Link>
          <Link to="/b08">
            <div className="b02-project sidemenu-reg">
              <svg
                viewBox="0 0 1024 1024"
                className="sidemenu-icon-reg mode-icon-sm-light"
              >
              ...
              <span className="b02-project-text mode-sm-typo-light sidemenu-typo-reg">
                Project
              </span>
            </div>
          </Link>
          <Link to="/b09">
            <div className="b02-customer-service sidemenu-reg">
              <svg
                viewBox="0 0 1024 1024"
                className="sidemenu-icon-reg mode-icon-sm-light"
              >
              ...
              <span className="b02-cs-text mode-sm-typo-light sidemenu-typo-reg">
                Customer Service
              </span>
            </div>
          </Link>
          <Link to="/b1001">
            <div className="b02-human-resource sidemenu-reg">
              <svg
              ...
              <span className="b02-hr-text mode-sm-typo-light sidemenu-typo-reg">
                HR Mgmt
              </span>
              <svg
                viewBox="0 0 1024 1024"
          ...
          <Link to="/b12">
            <div className="b02-learn-help sidemenu-reg">
              <svg
              ...
              <span className="b02-lh-text mode-sm-typo-light sidemenu-typo-reg">
                Learn &amp; Help
              </span>
            </div>
          </Link>
          <Link to="/b11">
            <div className="b02-reports sidemenu-reg">
              <svg
                viewBox="0 0 1024 1024"
                className="sidemenu-icon-reg mode-icon-sm-light"
              >
              ...
              <span className="b02-reports-text mode-sm-typo-light sidemenu-typo-reg">
                Reports
              </span>
            </div>
          </Link>
          <Link to="/b13">
            <div className="b02-settings sidemenu-reg">
              <svg
              ...
              <span className="b02-settings-text mode-sm-typo-light sidemenu-typo-reg">
                Settings
              </span>
            </div>
          </Link>

...
const B07 = (props) => {
  return (
    <div className="b07-container">
      <Helmet>
        <title>B07 - Ecstatic Merry Trout</title>
        <meta property="og:title" content="B07 - Ecstatic Merry Trout" />
      </Helmet>
      <div className="MainLayout">
        <div className="Sidemenu-Layout mode-sidemenu-light">
          ...
          <Link to="/b02">
            <div className="b07-my-workspace sidemenu-reg">
              <svg
                viewBox="0 0 1024 1024"
                className="sidemenu-icon-reg mode-icon-sm-light"
              >
          ...
          <div className="b07-assets-cont sidemenu-reg">
            <svg
              viewBox="0 0 1024 1024"
              className="sidemenu-icon-reg mode-icon-sm-light"
            >
            ...
            <span className="b07-assets-text LightBasicTypographyParagraph mode-sm-typo-light sidemenu-typo-reg">
              Assets
            </span>
          </div>
          <div className="b07-marketing-cont sidemenu-reg">
            <svg
              viewBox="0 0 1024 1024"
              className="sidemenu-icon-reg mode-icon-sm-light"
            >
            ...
            <span className="b07-marketing-text mode-sm-typo-light sidemenu-typo-reg">
              Marketing
            </span>
            <svg
              viewBox="0 0 1024 1024"
          ...
          <div className="b07-advertising-cont sidemenu-reg">
            <svg
              viewBox="0 0 1024 1024"
              className="sidemenu-icon-reg mode-icon-sm-light"
            >
            ...
            <span className="b07-advertising-text mode-sm-typo-light sidemenu-typo-reg">
              Advertising
            </span>
            <svg
              viewBox="0 0 1024 1024"
          ...
          <div className="sidemenu-active theme-indigo-menuactive">
            ...
            <span className="mode-typo-menuactive sm-typo-active">Sales</span>
          </div>
          <div className="b07-project-cont sidemenu-reg">
            <svg
              viewBox="0 0 1024 1024"
              className="sidemenu-icon-reg mode-icon-sm-light"
            >
            ...
            <span className="b07-project-text mode-sm-typo-light sidemenu-typo-reg">
              Project
            </span>
          </div>
          <div className="b07-cs-cont sidemenu-reg">
            <svg
              viewBox="0 0 1024 1024"
              className="sidemenu-icon-reg mode-icon-sm-light"
            >
            ...
            <span className="b07-cs-text mode-sm-typo-light sidemenu-typo-reg">
              Customer Service
            </span>
          </div>
          <div className="sidemenu-reg">
            ...
            <span className="b07-hr-text mode-sm-typo-light sidemenu-typo-reg">
              HR Mgmt
            </span>
            <svg
              viewBox="0 0 1024 1024"
          ...
          <div className="b07-learn-help sidemenu-reg">
            <svg
            ...
            <span className="b07-lh-text mode-sm-typo-light sidemenu-typo-reg">
              Learn &amp; Help
            </span>
          </div>
          <div className="b07-reports-cont sidemenu-reg">
            <svg
              viewBox="0 0 1024 1024"
              className="sidemenu-icon-reg mode-icon-sm-light"
            >
            ...
            <span className="b07-reports-text mode-sm-typo-light sidemenu-typo-reg">
              Reports
            </span>
          </div>
          <div className="sidemenu-reg">
            ...
            <span className="b07-settings-text mode-sm-typo-light sidemenu-typo-reg">
              Settings
            </span>
          </div>
        </div>
        <div className="mode-bodylo-light content-body-layout"></div>
      </div>
    </div>
  )
}

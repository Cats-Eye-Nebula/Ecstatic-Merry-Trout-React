...
const B01 = (props) => {
  return (
    <div className="b01-container">
      <Helmet>
        <title>Ecstatic Merry Trout</title>
        <meta property="og:title" content="Ecstatic Merry Trout" />
      </Helmet>
      <div className="MainLayout">
        <div className="Sidemenu-Layout">
          <div className="Sidemenu-logo">
            <div className="sidemenu-logo-size">
              <div className="b01-container2">
                <Script html={`This is just a sample`}></Script>
              </div>
            </div>
          </div>
          <div className="sidemenu-active theme-indigo-menuactive">
            <svg
              viewBox="0 0 1024 1024"
              className="mode-icon-menuactive sidemenu-icon-active"
            >
              <path d="M554 128h342v256h-342v-256zM554 896v-426h342v426h-342zM128 896v-256h342v256h-342zM128 554v-426h342v426h-342z"></path>
            </svg>
            <span className="mode-typo-menuactive sm-typo-active">
              Overview
            </span>
          </div>
          <Link to="/b02">
            <div className="sidemenu-reg">
              <svg
                viewBox="0 0 1024 1024"
                className="sidemenu-icon-reg mode-icon-sm-light"
              >
              ...
              <span className="mode-sm-typo-light sidemenu-typo-reg">
                My Workspace
              </span>
            </div>
          </Link>
          <Link to="/b03">
            <div className="sidemenu-reg">
              ...
              <span className="b01-text01010402 mode-sm-typo-light sidemenu-typo-reg">
                Calendar
              </span>
            </div>
          </Link>
          <Link to="/b04">
            <div className="b01-b01-assets sidemenu-reg">
              <svg
                viewBox="0 0 1024 1024"
                className="sidemenu-icon-reg mode-icon-sm-light"
              >
              ...
              <span className="b01-text01010502 LightBasicTypographyParagraph mode-sm-typo-light sidemenu-typo-reg">
                Assets
              </span>
            </div>
          </Link>
          <Link to="/b0501">
            <div className="b01-b01-marketing sidemenu-reg">
              <svg
                viewBox="0 0 1024 1024"
                className="sidemenu-icon-reg mode-icon-sm-light"
              >
              ...
              <span className="b01-text01010602 mode-sm-typo-light sidemenu-typo-reg">
                Marketing
              </span>
              <svg
                viewBox="0 0 1024 1024"
          ...
          <Link to="/b0601">
            <div className="b01-b01-advertising sidemenu-reg">
              <svg
                viewBox="0 0 1024 1024"
                className="sidemenu-icon-reg mode-icon-sm-light"
              >
              ...
              <span className="b01-text01010702 mode-sm-typo-light sidemenu-typo-reg">
                Advertising
              </span>
              <svg
                viewBox="0 0 1024 1024"
          ...
          <Link to="/b07">
            <div className="b01-b01-sales sidemenu-reg">
              <svg
              ...
              <span className="b01-text01010802 mode-sm-typo-light sidemenu-typo-reg">
                Sales
              </span>
            </div>
          </Link>
          <Link to="/b08">
            <div className="b01-b01-project sidemenu-reg">
              <svg
                viewBox="0 0 1024 1024"
                className="sidemenu-icon-reg mode-icon-sm-light"
              >
              ...
              <span className="b01-text01010902 mode-sm-typo-light sidemenu-typo-reg">
                Project
              </span>
            </div>
          </Link>
          <Link to="/b09">
            <div className="b01-b01-customer-service sidemenu-reg">
              <svg
                viewBox="0 0 1024 1024"
                className="sidemenu-icon-reg mode-icon-sm-light"
              >
              ...
              <span className="b01-text01011002 mode-sm-typo-light sidemenu-typo-reg">
                Customer Service
              </span>
            </div>
          </Link>
          <Link to="/b1001">
            <div className="b01-b01-human-resource sidemenu-reg">
              <svg
              ...
              <span className="b01-text01011102 mode-sm-typo-light sidemenu-typo-reg">
                HR Mgmt
              </span>
              <svg
                viewBox="0 0 1024 1024"
          ...
          <Link to="/b12">
            <div className="b01-b01-learn-help sidemenu-reg">
              <svg
              ...
              <span className="b01-text01011202 mode-sm-typo-light sidemenu-typo-reg">
                Learn &amp; Help
              </span>
            </div>
          </Link>
          <Link to="/b11">
            <div className="b01-b01-reports sidemenu-reg">
              <svg
                viewBox="0 0 1024 1024"
                className="sidemenu-icon-reg mode-icon-sm-light"
              >
              ...
              <span className="b01-text01011302 mode-sm-typo-light sidemenu-typo-reg">
                Reports
              </span>
            </div>
          </Link>
          <Link to="/b13">
            <div className="b01-b01-settings sidemenu-reg">
              <svg
              ...
              <span className="b01-text01011402 mode-sm-typo-light sidemenu-typo-reg">
                Settings
              </span>
            </div>
          </Link>
        </div>
        <div className="content-body-layout">
          <div className="b01-container3">
            <div className="b01-state-uncheck">
              <span className="b01-light">Light</span>
              <button className="b01-frame-form-switch-button">
                <img
                  alt="Vector3423"
                  src="/external/vector3423-6uf-200h.png"
                  className="b01-vector"
                />
              </button>
              <span className="b01-dark">Dark</span>
            </div>
          </div>
        </div>
      </div>

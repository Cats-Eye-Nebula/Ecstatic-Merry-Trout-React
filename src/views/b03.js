...
const B03 = (props) => {
  return (
    <div className="b03-container">
      <Helmet>
        <title>B03 - Ecstatic Merry Trout</title>
        <meta property="og:title" content="B03 - Ecstatic Merry Trout" />
      </Helmet>
      <div className="MainLayout">
        <div className="Sidemenu-Layout">
          ...
          <Link to="/">
            <div className="b03-overview sidemenu-reg">
              <svg
          ...
          <Link to="/b02">
            <div className="b03-my-workspace sidemenu-reg">
              <svg
                viewBox="0 0 1024 1024"
                className="sidemenu-icon-reg mode-icon-sm-light"
              >
          ...
          <Link to="/b04">
            <div className="b03-assets sidemenu-reg">
              <svg
                viewBox="0 0 1024 1024"
                className="sidemenu-icon-reg mode-icon-sm-light"
              >
              ...
              <span className="b03-assets-text mode-sm-typo-light LightBasicTypographyParagraph sidemenu-typo-reg">
                Assets
              </span>
            </div>
          </Link>
          <Link to="/b0501">
            <div className="b03-marketing sidemenu-reg">
              <svg
                viewBox="0 0 1024 1024"
                className="sidemenu-icon-reg mode-icon-sm-light"
              >
              ...
              <span className="b03-marketing-text mode-sm-typo-light sidemenu-typo-reg">
                Marketing
              </span>
              <svg
                viewBox="0 0 1024 1024"
          ...
          <Link to="/b0601">
            <div className="b03-advertising sidemenu-reg">
              <svg
                viewBox="0 0 1024 1024"
                className="sidemenu-icon-reg mode-icon-sm-light"
              >
              ...
              <span className="b03-advertising-text mode-sm-typo-light sidemenu-typo-reg">
                Advertising
              </span>
              <svg
                viewBox="0 0 1024 1024"
          ...
          <Link to="/b04">
            <div className="b03-sales sidemenu-reg">
              <svg
              ...
              <span className="b03-sales-text mode-sm-typo-light sidemenu-typo-reg">
                Sales
              </span>
            </div>
          </Link>
          <Link to="/b08">
            <div className="b03-project sidemenu-reg">
              <svg
                viewBox="0 0 1024 1024"
                className="sidemenu-icon-reg mode-icon-sm-light"
              >
              ...
              <span className="b03-project-text mode-sm-typo-light sidemenu-typo-reg">
                Project
              </span>
            </div>
          </Link>
          <Link to="/b09">
            <div className="b03-customer-service sidemenu-reg">
              <svg
                viewBox="0 0 1024 1024"
                className="sidemenu-icon-reg mode-icon-sm-light"
              >
              ...
              <span className="b03-cs-text mode-sm-typo-light sidemenu-typo-reg">
                Customer Service
              </span>
            </div>
          </Link>
          <Link to="/b1001">
            <div className="b03-human-resource sidemenu-reg">
              <svg
              ...
              <span className="b03-hr-text mode-sm-typo-light sidemenu-typo-reg">
                HR Mgmt
              </span>
              <svg
                viewBox="0 0 1024 1024"
          ...
          <Link to="/b12">
            <div className="b03-learn-help sidemenu-reg">
              <svg
              ...
              <span className="b03-lh-text mode-sm-typo-light sidemenu-typo-reg">
                Learn &amp; Help
              </span>
            </div>
          </Link>
          <Link to="/b11">
            <div className="b03-reports sidemenu-reg">
              <svg
                viewBox="0 0 1024 1024"
                className="sidemenu-icon-reg mode-icon-sm-light"
              >
              ...
              <span className="b03-reports-text mode-sm-typo-light sidemenu-typo-reg">
                Reports
              </span>
            </div>
          </Link>
          <Link to="/b13">
            <div className="b03-settings sidemenu-reg">
              <svg
              ...
              <span className="b03-settings-text mode-sm-typo-light sidemenu-typo-reg">
                Settings
              </span>
            </div>
          </Link>

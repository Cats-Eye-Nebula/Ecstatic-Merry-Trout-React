...
const B0610 = (props) => {
  return (
    <div className="b0610-container">
      <Helmet>
        <title>B0610 - Ecstatic Merry Trout</title>
        <meta property="og:title" content="B0610 - Ecstatic Merry Trout" />
      </Helmet>
      <div className="b0610-advertising-a">
        <div className="Sidemenu-Layout">
          <div className="b0610-logo">
            <img
              alt="image"
              src="https://play.teleporthq.io/static/svg/default-img.svg"
              className="b0610-image"
            />
          </div>
          <Link to="/">
            <div className="b0610-overview sidemenu-reg">
          ...
          <Link to="/b02">
            <div className="b0610-my-workspace sidemenu-reg">
              <svg viewBox="0 0 1024 1024" className="sidemenu-icon-reg">
          ...
          <Link to="/b03">
            <div className="b0610-calendar-cont sidemenu-reg">
              <svg
              ...
              <span className="b0610-calendar-text sidemenu-typo-reg">
                Calendar
              </span>
            </div>
          </Link>
          <Link to="/b04">
            <div className="b0610-assets-cont sidemenu-reg">
              <svg viewBox="0 0 1024 1024" className="sidemenu-icon-reg">
              ...
              <span className="b0610-assets-text LightBasicTypographyParagraph sidemenu-typo-reg">
                Assets
              </span>
            </div>
          </Link>
          <Link to="/b0501">
            <div className="b0610-marketing-cont sidemenu-reg">
              <svg viewBox="0 0 1024 1024" className="sidemenu-icon-reg">
              ...
              <span className="b0610-marketing-text sidemenu-typo-reg">
                Marketing
              </span>
              <svg viewBox="0 0 1024 1024" className="sidemenu-icon-reg">
          ...
          <div className="b0610-advertising sidemenu-reg">
            <div className="b0610-advertising1 sidemenu-reg">
              <svg viewBox="0 0 1024 1024" className="sidemenu-icon-reg">
              ...
              <span className="b0610-advertising-text sidemenu-typo-reg">
                Advertising
              </span>
              <svg viewBox="0 0 1024 1024" className="b0610-icon07">
            ...
            <Link to="/b0601" className="b0610-navlink05">
              <div className="b0610-ads-overview light-ssm-reg">
                <svg
                ...
                <span className="b0610-marketing-website sidemenu-typo-reg">
                  <span>Overview</span>
                  <br></br>
                </span>
              </div>
            </Link>
            <Link to="/b0602" className="b0610-navlink06">
              <div className="b0610-ads-ct light-ssm-reg">
                <svg
                  viewBox="0 0 877.7142857142857 1024"
                  className="light-ssm-icon-reg"
                >
                ...
                <span className="b0610-marketing-ct sidemenu-typo-reg">
                  Calendar &amp; Task
                </span>
              </div>
            </Link>
            <Link to="/b0603" className="b0610-navlink07">
              <div className="b0610-ads-sem light-ssm-reg">
                <svg
                  viewBox="0 0 877.7142857142857 1024"
                  className="b0610-marketing-icon-c light-ssm-icon-reg"
                >
                  <path d="M438.857 201.143c-171.429 0-310.857 139.429-310.857 310.857s139.429 310.857 310.857 310.857 310.857-139.429 310.857-310.857-139.429-310.857-310.857-310.857zM877.714 512c0 242.286-196.571 438.857-438.857 438.857s-438.857-196.571-438.857-438.857 196.571-438.857 438.857-438.857v0c242.286 0 438.857 196.571 438.857 438.857z"></path>
                </svg>
                <span className="b0610-marketing-website1 sidemenu-typo-reg">
                  Search Engine Mktg
                </span>
              </div>
            </Link>
            <Link to="/b0604" className="b0610-navlink08">
              <div className="b0610-ads-smm light-ssm-reg">
                <svg
                  viewBox="0 0 877.7142857142857 1024"
                  className="light-ssm-icon-reg"
                >
                ...
                <span className="b0610-marketing-website2 sidemenu-typo-reg">
                  Social Media Mktg
                </span>
              </div>
            </Link>
            <Link to="/b0605" className="b0610-navlink09">
              <div className="b0610-ads-display light-ssm-reg">
                <svg
                  viewBox="0 0 877.7142857142857 1024"
                  className="light-ssm-icon-reg"
                >
                ...
                <span className="b0610-marketing-website3 sidemenu-typo-reg">
                  Display Mktg
                </span>
              </div>
            </Link>
            <Link to="/b0606" className="b0610-navlink10">
              <div className="b0610-ads-mail light-ssm-reg">
                <svg
                  viewBox="0 0 877.7142857142857 1024"
                  className="light-ssm-icon-reg"
                >
                ...
                <span className="b0610-marketing-website4 sidemenu-typo-reg">
                  Direct Mail
                </span>
              </div>
            </Link>
            <Link to="/b0607" className="b0610-navlink11">
              <div className="b0610-ads-native light-ssm-reg">
                <svg
                  viewBox="0 0 877.7142857142857 1024"
                  className="light-ssm-icon-reg"
                >
                ...
                <span className="b0610-marketing-website5 sidemenu-typo-reg">
                  Native Ads
                </span>
              </div>
            </Link>
            <Link to="/b0608l" className="b0610-navlink12">
              <div className="b0610-ads-influencer light-ssm-reg">
                <svg
                  viewBox="0 0 877.7142857142857 1024"
                  className="light-ssm-icon-reg"
                >
                ...
                <span className="b0610-marketing-website6 sidemenu-typo-reg">
                  <span>Influencer Mktg</span>
                  <br></br>
                </span>
              </div>
            </Link>
            <Link to="/b0609" className="b0610-navlink13">
              <div className="b0610-ads-others light-ssm-reg">
                <svg
                  viewBox="0 0 877.7142857142857 1024"
                  className="light-ssm-icon-reg"
                >
                ...
                <span className="b0610-marketing-website7 sidemenu-typo-reg">
                  <span>Others</span>
                  <br></br>
                </span>
              </div>
            </Link>
            <div className="b0610-ads-settings light-ssm-active light-ssm-reg">
              <svg
                viewBox="0 0 877.7142857142857 1024"
                className="b0610-marketing-icon-b1 light-ssm-icon-reg"
              >
                <path d="M438.857 201.143c-171.429 0-310.857 139.429-310.857 310.857s139.429 310.857 310.857 310.857 310.857-139.429 310.857-310.857-139.429-310.857-310.857-310.857zM877.714 512c0 242.286-196.571 438.857-438.857 438.857s-438.857-196.571-438.857-438.857 196.571-438.857 438.857-438.857v0c242.286 0 438.857 196.571 438.857 438.857z"></path>
              </svg>
              <span className="b0610-marketing-ct1 sm-typo-active">
                Settings
              </span>
            </div>
          </div>
          <Link to="/b07">
            <div className="b0610-sales-cont sidemenu-reg">
              <svg
              ...
              <span className="b0610-sales-text sidemenu-typo-reg">Sales</span>
            </div>
          </Link>
          <Link to="/b08">
            <div className="b0610-project-cont sidemenu-reg">
              <svg viewBox="0 0 1024 1024" className="sidemenu-icon-reg">
              ...
              <span className="b0610-project-text sidemenu-typo-reg">
                Project
              </span>
            </div>
          </Link>
          <Link to="/b09">
            <div className="b0610-cs-cont sidemenu-reg">
              <svg viewBox="0 0 1024 1024" className="sidemenu-icon-reg">
              ...
              <span className="b0610-cs-text sidemenu-typo-reg">
                Customer Service
              </span>
            </div>
          </Link>
          <Link to="/b1001">
            <div className="b0610-hr-cont sidemenu-reg">
              <svg
              ...
              <span className="b0610-hr-text sidemenu-typo-reg">HR Mgmt</span>
              <svg viewBox="0 0 1024 1024" className="sidemenu-icon-reg">
                <path d="M426 256l256 256-256 256-60-60 196-196-196-196z"></path>
              </svg>
            </div>
          ...
          <Link to="/b12">
            <div className="b0610-learn-help sidemenu-reg">
              <svg
              ...
              <span className="b0610-lh-text sidemenu-typo-reg">
                Learn &amp; Help
              </span>
            </div>
          </Link>
          <Link to="/b11">
            <div className="b0610-reports-cont sidemenu-reg">
              <svg viewBox="0 0 1024 1024" className="sidemenu-icon-reg">
              ...
              <span className="b0610-reports-text sidemenu-typo-reg">
                Reports
              </span>
            </div>
          </Link>
          <Link to="/b13">
            <div className="b0610-settings sidemenu-reg">
              <svg
              ...
              <span className="b0610-settings-text sidemenu-typo-reg">
                Settings
              </span>
            </div>
          </Link>
